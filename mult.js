(function () {
  ...
  function add() {
    ...
    setTimeout(function () {
      $('[data-action=mult]').insertAfter($('[data-action=catalog]'));
    }, 2000);
  }
