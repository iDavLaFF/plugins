            ...
            $.get(t, function(e) {
                if (e.logos && e.logos[0]) {
                    ...
                    if ("" != t) {
                        ...
                        titleElement.after(`
                        <div class="logo-container" style="overflow: hidden; height: 6em; position: relative; display: none; margin-bottom: 1em;">
                        <div class="logo-animation" style="position: relative; width: 100%; transform: translateY(20px); opacity: 0; transition: all 0.5s ease;">
                            <img style="display: block; margin-bottom: 1em;" src="${Lampa.TMDB.image("/t/p/w500" + t.replace(".svg", ".png"))}"></div></div>`);
